...
def train(data_dir, model_dir, args):
    ...
    if args.dataset != 'MaskSplitByProfileDataset' and args.task != "age_regression":
    ...
    if args.lr_scheduler == 'CosineAnnealing':
        scheduler = CosineAnnealingWarmRestarts(optimizer, args.lr_decay_step)
    else:
        scheduler = OneCycleLR(optimizer, 0.01, args.lr_decay_step)
    ...
    for epoch in range(args.epochs):
        ...
        for idx, train_batch in enumerate(train_loader):
            ...
            if args.task == 'age_regression':
                ...
                loss = loss_fn(outs.squeeze(), labels)
            else:
        ...
        if args.task == 'age_regression':
            with torch.no_grad():
                ...
                for val_batch in val_loader:
                    ...
                    loss_item = loss_fn(outs.squeeze(), labels).item()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_scheduler', type=str, default="OneCycleLR", help='learning rate scheduler')
